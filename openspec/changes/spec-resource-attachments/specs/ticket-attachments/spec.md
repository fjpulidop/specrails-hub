...
The system SHALL accept an optional `attachmentIds: string[]` field in the `POST /tickets/:id/ai-edit` request body and inject files into the Claude CLI spawn using the same mechanism as generate-spec.
