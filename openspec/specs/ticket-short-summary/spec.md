# ticket-short-summary Specification

## Purpose

TBD - created by promoting delta spec from change `dashboard-postit-morph`. Defines the optional `short_summary` field on tickets, its production by Quick / Explore / AI Refine / SMASH flows, and its rendering in the postit dashboard tier.
